        ...
        <div class='search-body'>
            <div class='search-nav-warp'>
                <div class='search-nav' id='searchNav'>
                    <a href='${path}/searchAll.html' data-page='index' class='active'>全站</a>
			...
			<#list questionViews as r>
			
			
			<div class="wenda-item clearfix">
	
	<div class="wenda-item-title">
		<a href="${path}/selectAnswer.html?q=${questionId}" target="_blank">${r.questionTitle}</a>
	</div>
	
		<div class="wenda-item-top clearfix">
				<a  target="_blank" class="name">${r.questionText}</a>
	</div>
	</div>
