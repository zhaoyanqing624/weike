...
<div id="main">
    ...
    <div class="bg-other user-head-info">
        <div class="user-info">
            ...
            <p class="about-info">
                                        <#if u.userJob==0>无</#if>
                                        <#if u.userJob==13>学生</#if>
                                        <#if u.userJob==1>页面重构设计</#if>
                                        <#if u.userJob==6>Web前端工程师</#if>
                                        <#if u.userJob==5>JS工程师</#if>
                                        <#if u.userJob==8>PHP开发工程师</#if>
                                        <#if u.userJob==11>JAVA开发工程师</#if>
                                        <#if u.userJob==7>移动开发工程师</#if>
                                        <#if u.userJob==9>软件测试工程师</#if>
                                        <#if u.userJob==10>Linux系统工程师</#if>
                                        <#if u.userJob==2>交互设计师</#if>
                                        <#if u.userJob==3>产品经理</#if>
                                        <#if u.userJob==15>数据库工程师</#if>
                                        <#if u.userJob==4>UI设计师</#if>
                                        <#if u.userJob==17>CG影视动画师</#if>
                                        <#if u.userJob==16>全栈工程师</#if>

                <span class="u-info-learn">
                    </span>
                <span class='u-info-credit'>

                            <a>积分<em>${u.userAccount}</em></a>

        </span>


            </p>
            <p class="user-desc"><#if (u.userSignature==null)>这位同学很懒，木有签名的说～</#if>
            
                                 <#if (u.userSignature!=null)>${u.userSignature}</#if></p>
    ...
    <div class="wrap">
        ...
        <div class="slider" style="position:absolute">
            <div class="user-pic" data-is-fans="" data-is-follows="">
                ...
                <img class='img' src="${u.userImage}" alt=""/>
        ...
        <div class=' page-home js-usercard-box' id="notices">
            <div class="c-tab clearfix">
	          <div class="tool-left l">
                 ...
                 <a href="#" class="sort-item active">课程动态</a>
                 <a href="##" class="sort-item ">问题动态</a>
            ...
            <div class="item newcourse">
               <a  class="fl" href="${path}/user/personal.html" target="_blank">
                    <img src="${u.userImage}" class="userHead  js-usercard-dialog " width="40" height="40" data-userid=10000>
                </a>
                
                <div class="content fr">
                    <div class="head">
                        <div class="name">
                            <a class=" "  date-userid=3674640  href="${path}/listuser.html?u=${u.userId}" target="_blank">
                               ${u.userName}
                            </a>
                        </div>
                        <div class="time">
