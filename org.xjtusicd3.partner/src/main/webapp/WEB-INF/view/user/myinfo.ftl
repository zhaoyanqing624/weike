    ...
    <div class="page-settings">
        ...
        <div class="setting pb10">
            <div class="nav-tabs pa">
                ...
                <a href="${path}/user/myinfo2.html" class="countinfo fl">帐户信息</a>
                ...
                <div class="formBox">
                    <div id="setting-profile" class="setting-wrap setting-profile">
                        ...
                        <div class="wlfg-wrap clearfix ">
                            ...
                            <div class="rlf-group">
                                <img class="fl avator-img" name="userImage"  src="${session_userImage}"  width="180" height="180">
                                <div class="fl ml20 pr">
                                    <div id="avator-btns" class="avator-btn-inner">


                                        <div class="avator-btn-wrap">
                                            <form name="myform" enctype="multipart/form-data" action="${path}/uploadUserImage.html" method=post>
                        ...
                        <form id="profile" action="${path}/user/updatemyinfo.html" method="post">

                            <div class="wlfg-wrap clearfix">
                                <label class="label-name"  >昵称：</label>
                                <div class="rlf-group">
                                    <input type="text" name="userName"   autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session_userName}" placeholder="请输入昵称"/>
                            ...
                            <div class="wlfg-wrap clearfix">
                                ...
                                <div class="rlf-group">
                                    <input type="text" name="userPhone"   autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session_userPhone}" placeholder="请输入手机号"/>
                                    <p class="rlf-tip-wrap errorHint color-red" ></p>
                                </div>
                            </div>
                            ...
                            <div class="wlfg-wrap clearfix">
                                <label class="label-name" >职位：</label>
                                <div class="rlf-group">
                                    <select class="moco-form-control rlf-select" name="userJob" hidefocus="true"  data-validate="require-select">
                                    	
                                        <option value="0" <#if session_userJob==0>selected="selected" </#if>>请选择职位</option>
                                        <option value="13" <#if session_userJob==13>selected="selected" </#if>>学生</option>
                                        <option value="1" <#if session_userJob==1>selected="selected" </#if>>页面重构设计师</option>
                                        <option value="6" <#if session_userJob==6>selected="selected" </#if>>Web前端工程师</option>
                                        <option value="5" <#if session_userJob==5>selected="selected" </#if>>JS工程师</option>
                                        <option value="8" <#if session_userJob==8>selected="selected" </#if>>PHP开发工程师</option>
                                        <option value="11" <#if session_userJob==11>selected="selected" </#if>>JAVA开发工程师</option>
                                        <option value="7" <#if session_userJob==7>selected="selected" </#if>>移动开发工程师</option>
                                        <option value="9" <#if session_userJob==9>selected="selected" </#if>>软件测试工程师</option>
                                        <option value="10" <#if session_userJob==10>selected="selected" </#if>>Linux系统工程师</option>
                                        <option value="2" <#if session_userJob==2>selected="selected" </#if>>交互设计师</option>
                                        <option value="3" <#if session_userJob==3>selected="selected" </#if>>产品经理</option>
                                        <option value="15" <#if session_userJob==15>selected="selected" </#if>>数据库工程师</option>
                                        <option value="4" <#if session_userJob==4>selected="selected" </#if>>UI设计师</option>
                                        <option value="17" <#if session_userJob==17>selected="selected" </#if>>CG影视动画师</option>
                                        <option value="16" <#if session_userJob==16>selected="selected" </#if>>全栈工程师</option>
                            ...
                            <div class="wlfg-wrap clearfix">
                                ...
                                <div class="rlf-group">
                                    <input type="text" name="userAddress"   autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session_userAddress}" placeholder="请输入您的所在地址"/>
                                    <p class="rlf-tip-wrap errorHint color-red" ></p>
                                </div>
                            </div>
                            ...
                            <div class="wlfg-wrap clearfix">
                                ...
                                <div class="rlf-group rlf-radio-group" >
                                    ...
                                    <label  class="lh16"><input type="radio" hidefocus="true" value="0" <#if session_userSex==0>checked="checked"</#if>  name="userSex">保密</label>
                                    <label  class="lh16"><input type="radio" hidefocus="true" value="1" <#if session_userSex==1>checked="checked"</#if> name="userSex">男</label>
                                    <label  class="lh16"><input type="radio" hidefocus="true" value="2" <#if session_userSex==2>checked="checked"</#if>  name="userSex">女</label>
                                    <p class="rlf-tip-wrap errorHint color-red"></p>
                                </div>
                            </div>

                            <div class="wlfg-wrap clearfix">
                                <label class="label-name" >签名：</label>
                                <div class="rlf-group">
                                    <div class="pr">
                                        <textarea name="userSignature"    rows="5" class="noresize js-sign moco-form-control">${session_userSignature}</textarea>
