    ...
    <div class="page-settings">
        ...
        <div class="setting pb10">
            <div class="nav-tabs pa">
                ...
                <div class="countinfo active fl">成为教师</div>
                <div class="cb"></div>
            </div>
                ...
                <div class="formBox">
                    <div id="setting-profile" class="setting-wrap setting-profile">
                        ...
                        <div class="wlfg-wrap clearfix ">
                            <label class="label-name" for="job">证件照：</label>
                            <div class="rlf-group">
                                <img class="fl avator-img" id="js-portrait"  src="${session_userCardImage}" data-portrait="578a158a0001c17512391242" width="180" height="180">
                                <div class="fl ml20 pr">
                                    <div id="avator-btns" class="avator-btn-inner">


                                        <div class="avator-btn-wrap">
                                            <form name="myform" enctype="multipart/form-data" action="${path}/uploadUserCardImage.html" method=post>
                         ...
                         <form id="profile" action="${path}/user/updatemyinfo3.html" method="post">

                            <div class="wlfg-wrap clearfix">
                                <label class="label-name"  >姓名：</label>
                                <div class="rlf-group">
                                    <input type="text" name="userTrueName"   autocomplete="off"  class="moco-form-control" value="${session_userTrueName}" placeholder="请输入姓名"/>
                                    <p class="rlf-tip-wrap errorHint color-red" ></p>
                                </div>
                            </div>
                            
                           <div class="wlfg-wrap clearfix">
                                <label class="label-name"  >证件号：</label>
                                <div class="rlf-group">
                                    <input type="text" name="userCardNumber"   autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session_userCardNumber}" placeholder="请输入有效证件号"/>
                                    <p class="rlf-tip-wrap errorHint color-red" ></p>
                                </div>
                            </div>
                            ...
                            <div class="wlfg-wrap clearfix">
                                ...
                                <div class="rlf-group">
                                    <input type="text" name="userTrueJob"   autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session_userTrueJob}" placeholder="请输入您的职位"/>
                                    <p class="rlf-tip-wrap errorHint color-red" ></p>
                                </div>
                            </div>
                            
                            <div class="wlfg-wrap clearfix">
                                <label class="label-name" >经历：</label>
                                <div class="rlf-group">
                                    <div class="pr">
                                        <textarea name="userExperience"    rows="5" class="noresize js-sign moco-form-control" placeholder="请输入您的工作经历">${session_userExperience}</textarea>
                            ...
                            <div class="wlfg-wrap clearfix">
                                <label class="label-name h16 lh16 style="margin-left:10px" >申请状态：</label>
                                <div class="rlf-group rlf-radio-group" >
                                	
                                    <label  class="lh16"><input type="radio" hidefocus="true" value="0" disabled<#if session_userState==0>checked="checked"</#if> >未通过</label>
                                    <label  class="lh16"><input type="radio" hidefocus="true" value="1" disabled<#if session_userState==1>checked="checked"</#if> >待审核</label>
                                    <label  class="lh16"><input type="radio" hidefocus="true" value="2" disabled<#if session_userState==2>checked="checked"</#if> >审核成功</label>
                                    <p class="rlf-tip-wrap errorHint color-red"></p>
                                </div>
                            </div>
