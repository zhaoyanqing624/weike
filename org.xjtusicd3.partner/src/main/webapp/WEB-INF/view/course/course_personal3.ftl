...
<#if session_userJob==0>无</#if>
    ...
    <div class="wrap">
        ...
        <div class="slider">
            ...
            <ul>
                ...
                <li>
                    <a href="${path}/user/course_personal.html" class="active">
	...
	<div class="tool-left l">
                 ...
                 <#if session_userState==2><a href="${path}/course/course_personal3.html"  class="sort-item active">发布课程</a></#if>
			...
			<div class="contentBox">
                <div class="formBox">
                    <div id="setting-profile" class="setting-wrap setting-profile">
                       <form id="profile" action="addcourseTitle.html" method="post">

                            <div class="wlfg-wrap clearfix">
                                <label class="label-name"  >题目：</label>
                                <div class="rlf-group">
                                    <input type="text" name="courseTitle"   autocomplete="off"  data-validate="require-nick"  class="moco-form-control"  placeholder="请输入课程名称"/>
