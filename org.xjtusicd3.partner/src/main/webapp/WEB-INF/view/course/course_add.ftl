            ...
            <div class="contentBox">
                <div class="formBox">
                    <div id="setting-profile" class="setting-wrap setting-profile">
                        ...
                        <form id="profile" action="addcourseTitle2.html" method="post">

                            <div class="wlfg-wrap clearfix">
                                <label class="label-name"  >名称：</label>
                                <div class="rlf-group">
                                    <input type="text" name="courseTitle"   autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session_courseTitle}" readonly="readonly"/>
                            ...
                            <div class="wlfg-wrap clearfix">
                                ...
                                <div class="rlf-group">
                                    <input type="text" name="courseShortIntroduce"   autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session_courseShortIntroduce}" placeholder="请简短介绍课程"/>
                                    <p class="rlf-tip-wrap errorHint color-red" ></p>
                                </div>
                            </div>
                            ...
                            <div class="wlfg-wrap clearfix">
								...
								<div class="rlf-group">
								<select id="first-menu" class="moco-form-control rlf-select"  onchange="selectSecondChild();" ></select>
								<select id="second-menu" class="moco-form-control rlf-select" name="classifyName"></select>
								<p class="rlf-tip-wrap errorHint color-red" ></p>
								</div>	
  							</div>
                            ...
                            <div class="wlfg-wrap clearfix">
                                ...
                                <div class="rlf-group">
                                    <select class="moco-form-control rlf-select" name="courseDifficulty"  hidefocus="true"  data-validate="require-select">
                                    	
                                        <option value="初" <#if session_userDifficulty=='初'>selected="selected" </#if>>初</option>
                                        <option value="中" <#if session_userDifficulty=='中'>selected="selected" </#if>>中</option>
                                        <option value="高" <#if session_userDifficulty=='高'>selected="selected" </#if>>高</option>
                            ...
                            <div class="wlfg-wrap clearfix">
                                ...
                                <div class="rlf-group">
                                    <div class="pr">
                                        <textarea name="courseIntroduce"    rows="5" class="noresize js-sign moco-form-control">${session_courseIntroduce}</textarea>
                            ...
                            <div class="wlfg-wrap clearfix">
                                ...
                                <div class="rlf-group">
                                    <div class="pr">
                                        <textarea name="courseNeedkonw"    rows="5" class="noresize js-sign moco-form-control">${session_courseNeedkonw}</textarea>
                                        <p class="numCanInput"></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="wlfg-wrap clearfix">
                                ...
                                <div class="rlf-group">
                                    <div class="pr">
                                        <textarea name="courseWilllearn"    rows="5" class="noresize js-sign moco-form-control">${session_courseWilllearn}</textarea>
                                        <p class="numCanInput"></p>
                                    </div>
                                </div>
                            </div>
