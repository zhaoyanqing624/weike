        ...
        <div class="setting pb10">
            <div class="nav-tabs pa">
                ...
                <a  class="countinfo fl">内容信息</a>
                 <input type="button" style=" color:red;margin-left:600px;margin-top:30px;font-size:20px;font-weight:bold" value="下一步" onclick="javascrtpt:window.location.href='${path}/course/course_add2.html'">
                <div class="cb"></div>
            </div>
                ...
                <div class="formBox">
                    <div id="setting-profile" class="setting-wrap setting-profile">
                        <div class="wlfg-wrap clearfix ">
                            <label class="label-name" for="job">缩略图：</label>
                            <div class="rlf-group">
                                <img class="fl avator-img" id="courseImage"  src="${session_courseImage}"  width="180" height="180">
