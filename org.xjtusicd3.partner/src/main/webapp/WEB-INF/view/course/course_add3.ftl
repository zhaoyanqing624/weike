    ...
    <div class="page-settings">
        ...
        <div class="setting pb10">
            <div class="nav-tabs pa">
                <a class="baseinfo fl"">课程信息</a>
                <div class="countinfo active fl">内容信息</div>
                 <input type="button" style=" color:red;margin-left:600px;margin-top:30px;font-size:20px;font-weight:bold" value="完成" onclick="javascrtpt:window.location.href='${path}/course/mycourse.html'">
                <div class="cb"></div>
            </div>
            <div class="contentBox">
                <div class="formBox">
                    <div id="setting-profile" class="setting-wrap setting-profile">
                        <form id="profile" action="addvideo.html" method="post">
                        
                        	 <div class="wlfg-wrap clearfix">
								<label class="label-name"  >章节：</label>
								<div class="rlf-group">
								<select id="first-menu" name="courseTitle" class="moco-form-control rlf-select" onclick="getFirstTitle()></select>
                            ...
                            <div class="wlfg-wrap clearfix">
                                <label class="label-name"  >小节：</label>
                                <div class="rlf-group">
                                    <input type="text" name="videoName"   autocomplete="off"  data-validate="require-nick"  class="moco-form-control"  placeholder="请输入视频标题"/>
                                    <p class="rlf-tip-wrap errorHint color-red" ></p>
                                </div>
                            </div>
  					        ...
  					        <div class="wlfg-wrap clearfix">
                                ...
                                <div class="rlf-group">
                                    <button id="profile-submit" onclick="javascrtpt:window.location.href='${path}/course/course_add3_video.html'" hidefocus="true"  aria-role="button" class="rlf-btn-green btn-block profile-btn" >上传视频</button>
                                </div>
                            </div>
  					   </form>
...
$(document).ready(
   function getFirstTitle(){
         $.ajax({
             type: "GET",
             url: "${path}/getFirstTitle.html",            
             dataType: "json",
             success: function(data){            
     			 for(var i in data){ 
     			 	 document.getElementById("first-menu").options.add(new Option(data[i].courseTitle, data[i].courseTitleId));					        
			      }                                                                      
             }
         });
    })
