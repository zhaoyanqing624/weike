    ...
    <div class="page-settings">
        ...
        <div class="setting pb10">
            <div class="nav-tabs pa">
                ...
                <input type="button" style=" color:red;margin-left:600px;margin-top:30px;font-size:20px;font-weight:bold" value="下一步" onclick="javascrtpt:window.location.href='${path}/course/course_add3.html'">
                <div class="cb"></div>
            </div>
            <div class="contentBox">
                <div class="formBox">
                    <div id="setting-profile" class="setting-wrap setting-profile">
                        ...
                        <form id="profile" action="addcourseTitle3.html" method="post">

                            <div class="wlfg-wrap clearfix">
                                <label class="label-name"  >章节：</label>
                                <div class="rlf-group">
                                    <input type="text" name="courseTitle"   autocomplete="off"  data-validate="require-nick"  class="moco-form-control"  placeholder="请输入章节标题"/>
                            ...
                            <div class="wlfg-wrap clearfix">
                                ...
                                <div class="rlf-group">
                                    <button id="profile-submit"  hidefocus="true"  aria-role="button" class="rlf-btn-green btn-block profile-btn" >添加标题</button>
                                	<p class="rlf-tip-wrap errorHint color-red"></p>
                                </div>
                            </div>
                        ...
                        <div class="wlfg-wrap clearfix">
								<label class="label-name"  >章节预览：</label>
								<div class="rlf-group">
