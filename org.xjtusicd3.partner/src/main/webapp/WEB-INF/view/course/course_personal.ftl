...
<#if session_userJob==0>无</#if>
    ...
    <div class="wrap">
        ...
        <div class="slider">
            ...
            <ul>
                ...
                <li>
                    <a href="${path}/course/course_personal.html" class="active">
	...
	<div class="tool-left l">
                 ...
                 <a href="${path}/course/lastcourse.html" class="sort-item active">最近学习</a>
                 <#if session_userState==2><a href="${path}/course/mycourse.html" class="sort-item ">我的课程</a></#if>
	...
	<#list lastCourseViews as a>
				<div class="clearfix tl-item  tl-item-first">
			<span class="time">
				<#assign content=a.recordDate>
            ...
            <div class="course-list course-list-m">
                <ul class="clearfix">
                        ...
                        <div class="course-list-cont">
								...
								<span class="i-right span-common">学习至:   <#t> ${a.videoName}</span>
							</div>
								                        <div class="catog-points">
								

							 <a href="${path}/course/course3.html?c=${a.videoId}" target="_blank" class="btn-red continute-btn">继续学习</a>
