        ...
        <div id="login-area">
            <ul class="header-unlogin clearfix">
                ...
                <li class="set_btn user-card-box">
					...
					<p class="meta">                
					<a href="/u/3674640/credit">积分<b id="js-user-credit">${session_userAccount}</b></a></p>                            
					</div>
					...
					<a  href="loginout.html"  class="r">退出</a>                        
					</div>            
					</div>           
					<i class="card-arr">
					</i>
...
<#if session_userJob==0>无</#if>
            ...
            <div class="study-info clearfix">
                <div class="item follows">
                    <a href='/u/3674640/follows'><em>1</em></a>

                    <span>关注</span>
                </div>
                <div class="item followers">
                    <a href='/u/3674640/fans'><em>0</em></a>
                    <span>粉丝</span>
                </div>
    ...
    <div class="wrap">
        ...
        <div class="slider" style="position:absolute">
            ...
            <ul>
                ...
                <li>
                    <a href="${path}/course/lastcourse.html" >
                        <i class="icon-tick"></i><span>课程</span><b class="icon-drop_right"></b>
                    </a>
                </li>

                <li>
                    <a href="/u/3674640/szcourses/list" >
        ...
        <div class=' page-home js-usercard-box' id="notices">
            <div class="dyanmic-title-wrap">
                <p class="dynamic-title">最新动态  <span class="tip-setting pointer fr"><span class="settingicon"> <i class="icon-set2"></i> </span></span>
                </p>
            </div>


			<#list userpersonalViews as a>
            <div class="item newcourse">
               <a  class="fl" href="${path}/user/personal.html" target="_blank">
                ...
                <div class="content fr">
                    <div class="head">
                        <div class="name">
                            <a class=" "  date-userid=3674640  href="${path}/user/personal.html" target="_blank">
                               ${session_userName}
                            </a>
                        </div>
                        <div class="time">
                    ...
                    <div class="body pr h135">
                        <a href="/learn/598" target=_blank>
                            <img  class="fl" src="http://img.mukewang.com/56a6e218000122ca06000338.jpg" width="240" height="135"/>
                            <div class="content w636 fr">
                                <div class="subtitle">
                                    ${session_courseTitle}
                                </div>
                                <div class="describe">
                                    <span >${session_courseDifficulty}级</span>
                                    <span class="ml20"><strong><#if (a.courseTime/60<=1) >${a.courseTime}分</#if>
                    <#if (a.courseTime/60>=1) >${(a.courseTime-a.courseTime%60)/60}时${a.courseTime%60}分</#if></strong></span>
                                </div>
                                <div class="detail">
								${session_courseIntroduce}
                                </div>
                            </div>
            ...
            <div class="item newanswer">
                ...
                <a  class="fl" href="/u/10000" target="_blank">
                ...
                <div class="content fr">
                    <div class="head">
                        <div class="name">
                            <a class=" js-usercard-dialog "  href="/u/10000"  data-userid=10000  target="_blank">
                                慕女神
                            </a>
                        </div>
                        <div class="time">
                    ...
                    <div class="body pr">
                        <a class="fl" href="/wenda/12" target="_blank">
                            <img   src="http://img.mukewang.com/563aff7e0001c8c700900090.jpg" width="40" height="40" title="Android">
                        </a>
                        <div class="content">
                            <div class="tag">
                                <span >来自</span>
                                <a href="/wenda/12" target="_blank">
                                    <span class="ml10">Android</span>
                                </a>
                                <a href="/wenda/22" target="_blank">
                                    <span class="ml10">AngularJS</span>
                                </a>
                                <a href="/wenda/24" target="_blank">
                                    <span class="ml10">Bootstrap</span>
                                </a>
                            </div>
                            <div class="subtitle">
                                <a href="/wenda/detail/335169" target="_blank">
                                    怎么注销账户啊？
            ...
            <div class="item newplan">
                ...
                <a href="/u/3674640" target="_blank">
                    <img src="http://img.mukewang.com/578a158a0001c17512391242-40-40.jpg" class="userHead   " width="40" height="40" data-userid=3674640>
                </a>
                <div class="content fr ">
                    <div class="head">
                        <div class="name">
                            <a class=" "  href="/u/3674640"  data-userid=3674640 target="_blank">
                                隔壁班的zhao叔数3674640
                            </a>
                        </div>
                        <div class="time">
                    ...
                    <a href="/course/programdetail/pid/32" target="_blank">
                        <div class="body pr">

                            <img src="http://img.mukewang.com/58341b88000176ce06000338.jpg" width="240" height="180">
                            <div class="content w636 fr">
                                <div class="subtitle">
                                    Web前端工程师
                                </div>
                                <div class="describe">
                                    <span >求职计划</span> <span class="ml20">28门课</span>
                                </div>
                                <div class="detail">
                                    随着互联网的发展速度迅猛，前端工程师职业越来越火热，想学习Web前端技能吗 ? 该路径从基础知识到实战案例演练，一步步带您快速掌握如何搭建网站静态页面、开发网站交互特效，为您打开WEB前端工程师大门。还在等什么？快来学习吧!
                                </div>
                            </div>
