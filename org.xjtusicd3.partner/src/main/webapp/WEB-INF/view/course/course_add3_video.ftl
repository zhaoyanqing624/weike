                ...
                <div class="formBox">
                    <div id="setting-profile" class="setting-wrap setting-profile">
                            ...
                            <div class="wlfg-wrap clearfix">
                                <label class="label-name"  >视频内容：</label>
                                <div class="rlf-group">
                                    <input type="text" name="videoName"   autocomplete="off"  data-validate="require-nick"  class="moco-form-control"  value="${session_videoName}"/>
							...
							<div class="wlfg-wrap clearfix ">
                            <label class="label-name" for="job">视频：</label>
                            <div class="rlf-group">
                                <div class="fl ml20 pr">
                                    <div id="avator-btns" class="avator-btn-inner">
                                        <div class="avator-btn-wrap">
                                            <form name="myform" enctype="multipart/form-data" action="${path}/uploadVideo.html" method=post>
