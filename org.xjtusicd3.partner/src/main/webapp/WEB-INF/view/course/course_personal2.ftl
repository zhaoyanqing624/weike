...
<head>
    <meta charset="utf-8">
    <title>${session_userName}的动态</title>
...
var ownName=""
    ...
    <link rel="stylesheet" href="${path}/static/css/zhao/course_personal.css" type="text/css" />
...
<div id="main">
    ...
    <div class="bg-other user-head-info">
        <div class="user-info">
            ...
            <!--25-->
            <p class="about-info">
<#if session_userJob==0>无</#if>
                                        <#if session_userJob==13>学生</#if>
                                        <#if session_userJob==1>页面重构设计</#if>
                                        <#if session_userJob==6>Web前端工程师</#if>
                                        <#if session_userJob==5>JS工程师</#if>
                                        <#if session_userJob==8>PHP开发工程师</#if>
                                        <#if session_userJob==11>JAVA开发工程师</#if>
                                        <#if session_userJob==7>移动开发工程师</#if>
                                        <#if session_userJob==9>软件测试工程师</#if>
                                        <#if session_userJob==10>Linux系统工程师</#if>
                                        <#if session_userJob==2>交互设计师</#if>
                                        <#if session_userJob==3>产品经理</#if>
                                        <#if session_userJob==15>数据库工程师</#if>
                                        <#if session_userJob==4>UI设计师</#if>
                                        <#if session_userJob==17>CG影视动画师</#if>
                                        <#if session_userJob==16>全栈工程师</#if>

                
                <span class='u-info-credit'>

                            <a href='/u/3674640/credit'>积分<em>${session_userAccount}</em></a>

        </span>


            </p>
            <p class="user-desc"><#if (session_userSignature==null)>这位同学很懒，木有签名的说～</#if>
            
                                 <#if (session_userSignature!=null)>${session_userSignature}</#if></p>
    ...
    <div class="wrap">
        ...
        <div class="slider">
            <div class="user-pic" data-is-fans="" data-is-follows="">
                ...
                <img class='img' src="${session_userImage}" alt=""/>
            ...
            <ul>
                ...
                <li>
                    <a href="${path}/course/lastcourse.html" class="active">
                ...
                <li>
                    <a href="" >
                        <i class="icon-shizhan"></i><span>实战</span><b class="icon-drop_right"></b>
                    </a>
                </li>
                ...
                <li>
                    <a href="" >
                        <i class="icon-plan"></i><span>路径</span><b class="icon-drop_right"></b>
                    </a>
                </li>
	...
	<div class="tool-left l">
                 ...
                 <a href="${path}/course/lastcourse.html" class="sort-item ">最近学习</a>
                 <#if session_userState==2><a href="${path}/course/mycourse.html"  class="sort-item active">我的课程</a></#if>
                 <#if session_userState==2><a href="${path}/course/course_personal3.html"  class="sort-item ">发布课程</a></#if>
        
    </div>
    <div class="tool-right r">
    	<div  class="tool-all">
            <span  id="nb" onClick="show('sb','nb')" class="tool-item" >
                <span id >全部课程</span>
        	</span>
            <ul id="sb" class="all-cont" style="display:none">
            <li><a  href="${path}/course/mycourse.html">全部课程</a></li>
          	<li><a  href="${path}/course/mycourse1.html">待审核</a></li>
           	<li><a  href="${path}/course/mycourse2.html">已通过</a></li>
            </ul>
        </div>
    </div>
...
<#list courseListViews as a>		
		<div class="clearfix tl-item  tl-item-first">
			<span class="time">
				<#assign content=a.courseDate>
                <b>${content?substring(0,4)}</b>
                <em>${content?substring(5,7)}月${content?substring(8,10)}日</em>
            </span>
            <div class="course-list course-list-m">
                <ul class="clearfix">
                	                    <li class="course-one" data-courseid="755" data-uid="3674640">
                        <div class="course-list-img l">
	                        <a href="${path}/course/courseupdate.html?t=${a.courseTitleId}" target="_blank">
	                            <img width="200" height="113"  src="${a.courseImage}" />
	                        </a>
                        </div>
                        <div class="course-list-cont">
                        	<h3 class="study-hd">
	                            <a href="${path}/course/courseupdate.html?t=${a.courseTitleId}" target="_blank">${a.courseTitle}</a>
						 	</h3>
	                        	<div class="study-points">
								<span class="i-left span-common">${a.classifyName}</span>
								<span class="i-right span-common">${a.courseShortIntroduce}</span>
							</div>
							
						<div class="catog-points">
								<#if a.courseState==2>		
							 <a  target="_blank" class="btn-red continute-btn">审核失败</a>
							 	</#if>
								<#if a.courseState==0>		
							 <a  target="_blank" class="btn-red continute-btn">待审核</a>
							 	</#if>
							 	<#if a.courseState==1>
							 	<span class="i-left span-common"><a >时长： <i><#if (a.courseTime/60<=1) >${a.courseTime}分</#if>
                    														<#if (a.courseTime/60>=1) >${(a.courseTime-a.courseTime%60)/60}时${a.courseTime%60}分</#if></i></a></span>
							 	<span class="i-left span-common"><a >学习人数： <i>0</i></a></span>
							 	<span class="i-left span-common"><a >课程评分：<i>0</i></a></span>
							    <a  target="_blank" class="btn-red continute-btn">已通过</a>
							    </#if>
							</div>
                        </div>
                    </li>
	...
	<div class="qa-comment-page">
					<div class="page"><span class="disabled_page">首页</span><span class="disabled_page">上一页</span><a href="javascript:void(0)" class="active text-page-tag">1</a><a class="text-page-tag" href="/u/3674640/courses?page=2">2</a><a href="/u/3674640/courses?page=2">下一页</a><a href="/u/3674640/courses?page=2">尾页</a></div>
			</div>
...
<script type="text/javascript">
<script type="text/javascript" src="${path}/static/page/u/courses.js"></script>
<script type="text/javascript" src="${path}/static/page/u/u_common.js"></script>
