        ...
        <div class='search-body'>
            <div class='search-nav-warp'>
                <div class='search-nav' id='searchNav'>
                    ...
                    <a href='${path}/searchCourse.html' data-page='course' >课程</a>
                    <a href='${path}/searchQuestion.html' data-page='wenda' class='active'>猿问</a>
                </div>
            </div>
            <div class='search-related'>
                共找到 ${questionListNumber} 个相关内容
            </div>


			
	<h2 class='search-title'>问题</h2>
	<#list questionViews as t>
	<div class="wenda-item clearfix">
	
	<div class="wenda-item-title">
		<a href="${path}/selectAnswer.html?q=${questionId}" target="_blank">${t.questionTitle}</a>
	</div>
	
		<div class="wenda-item-top clearfix">
				<a  target="_blank" class="name">${t.questionText}</a>
	</div>
	</div>
	</#list>		
            ...
            <p class='href-warp'><a href=''>更多问题搜索结果</a></p>
